...
<!-- Try to assess relationships with regression  -->
<!-- Problem Subject is only one variable how do we argue using more then that -->

```{r echo=FALSE, message=FALSE, warning=FALSE}
knitr::read_chunk("./scripts/strength_of_relationship.r")
```

```{r strength_of_relationship, echo=FALSE, message=FALSE, warning=FALSE}
```


<!-- We can try to learn a cluster for predicting destinations -->
<!-- Problem Subject is only one variable how do we argue using more then that -->